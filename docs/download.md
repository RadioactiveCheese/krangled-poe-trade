...
Download Krangled PoE Trade from this project's GitHub Releases. Builds from
unofficial mirrors have not been verified.
...
In order for Krangled PoE Trade to have access to the PoE window, it must be started with Administrator rights.**
